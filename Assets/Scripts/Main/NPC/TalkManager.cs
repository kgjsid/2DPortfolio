...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        //talkData.Add(1, new string[] { "Test" });
        ...
        //talkData.Add(100, new string[] { "Bulbasaur" });
        //talkData.Add(101, new string[] { "Squirtle" });
        //talkData.Add(102, new string[] { "Charmander" });
    ...
    {
        Manager.UI.SetPlayerInteract(true);
        ...
        Manager.UI.SetPlayerInteract(false);
    }
}
